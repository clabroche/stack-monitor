      ...
      <div class="header">
        ...
        <div class="right">
          ...
          <div class="icons">
            ...
            <img v-if="currentService.spawnOptions && currentService.spawnOptions.cwd" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Visual_Studio_Code_1.35_icon.svg/240px-Visual_Studio_Code_1.35_icon.svg.png" alt="vscode icon"  aria-hidden="true" title="Open in Visual Studio Code" @click="openInVsCode()"/>
