...
const isComponent = computed(() => {
  return router.currentRoute.value.path.includes('/Finder')
})
...
const displayedGroups = computed(() => {
  return Object.keys(groups.value).map(key => {
...
/**
 * @typedef {(import('./routes').FinderChoice & {active?: boolean })} FinderChoice
 */
</script>
